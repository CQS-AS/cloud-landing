var client;client=angular.module("client",["dir.moreless","dir.nav.collapse","dir.popover","dir.scroller","dir.scrollto"]),client.config(["$locationProvider",function(r){return r.html5Mode(!1)}]);
...
angular.module("dir.scroller",[]).directive("dirScroller",["$timeout",function(r){return{restrict:"A",link:function(e,t,i){var n,l,c;return c=JSON.parse(i.dirScroller),n=-1,l=function(){++n===c.length&&(n=0),t.text(c[n]),r(l,3e3)},l()}}}]);

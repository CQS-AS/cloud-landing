var client;client=angular.module("client",["ctrl.calculator","dir.moreless","dir.nav.collapse","dir.popover","dir.scroller","dir.scrollto"]),client.config(["$locationProvider",function(l){return l.html5Mode(!1)}]);
angular.module("ctrl.calculator",[]).controller("ctrlCalculator",["$scope",function(t){var o,s;return t.calc={users:5,files:10},t.total={year:0,month:0,storeInc:0,storeExtra:0},o={fileGB:.05,userGB:5,storeGB:5,userCost:660,storeCost:55,singleCost:1320,officeCost:3300},s=function(){var s,e,r,c,a,l;return t.calc.users>0?(r=1===t.calc.users?o.singleCost:o.officeCost,c=1===t.calc.users?1:5,e=Math.max(0,t.calc.users-c),l=e*o.userCost,t.total.storeInc=1*o.userGB*t.calc.users,s=t.calc.files*o.fileGB,console.log("calcStore="+s+", calcStore-storeInc="+(s-t.total.storeInc)),t.total.storeExtra=Math.ceil(Math.max(0,(s-t.total.storeInc)/o.storeGB)),a=t.total.storeExtra*o.storeCost,t.total.year=r+l,t.total.month=a):void 0},t.$watch("calc.users",s),t.$watch("calc.files",s),this}]);

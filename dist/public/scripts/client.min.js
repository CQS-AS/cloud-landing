var client;client=angular.module("client",["ctrl.calculator","ctrl.invite","dir.moreless","dir.nav.collapse","dir.popover","dir.scroller","dir.scrollto"]),client.config(["$locationProvider",function(l){return l.html5Mode(!1)}]);
angular.module("ctrl.calculator",[]).controller("ctrlCalculator",["$scope",function(t){var a,s;return t.calc={users:10,files:100},t.total={plan:0,users:{inc:0,add:0},cost:{plan:0,add:0},year:0,month:0,store:{inc:0,add:0,extra:0}},a={fileGB:.05,userGB:5,storeGB:5,userCost:660,storeCost:55,singleCost:1320,officeCost:3300},s=function(){var s;return t.calc.users>0?(t.total.plan=1===t.calc.users?0:1,t.total.users.inc=1===t.calc.users?1:5,t.total.users.add=Math.max(0,t.calc.users-t.total.users.inc),t.total.cost.plan=1===t.calc.users?a.singleCost:a.officeCost,t.total.cost.add=t.total.users.add*a.userCost,t.total.year=t.total.cost.plan+t.total.cost.add,t.total.store.inc=1*a.userGB*t.total.users.inc,t.total.store.add=1*a.userGB*t.total.users.add,s=t.calc.files*a.fileGB,t.total.store.extra=Math.ceil(Math.max(0,(s-(t.total.store.inc+t.total.store.add))/a.storeGB)),t.total.month=t.total.store.extra*a.storeCost):void 0},t.$watch("calc.users",s),t.$watch("calc.files",s),this}]);
angular.module("ctrl.invite",[]).controller("ctrlInvite",["$scope",function(e){return e.employees="11-25 employees",e.time="No",e.country="South Africa",e.tandc=!1}]);
